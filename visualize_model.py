...
if __name__ == '__main__':
    ...
    checkpoint = torch.load("runs/AirHockeyReach__SarthakTraining2_UpdateReward__1__2024-01-04_20-11-51/SarthakTraining2_UpdateReward.cleanrl_model", map_location=torch.device("cpu"))
    while True:
        env = thunk()
        # Set the camera
